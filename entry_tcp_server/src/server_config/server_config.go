...
import (
	...
	"os"
	"path/filepath"
	constant "tcp_server/src/common"
)
...
func InitServerConfig() {
	...
	section = configFile.Section("db")
	GlbserverConfig.DbSource = section.Key("source").String()
	GlbserverConfig.DbDriver = section.Key("driver").String()
